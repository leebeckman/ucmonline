...
(function() {
	...
	*/
	...
	window.addEvent("domready", function() {
		...
		fx = {
			overlay: new Fx.Tween(overlay, {property: "opacity", duration: 0}).set(0),
			image: new Fx.Tween(image, {property: "opacity", duration: 0, onComplete: captionAnimate}),
			bottom: new Fx.Tween(bottom, {property: "opacity", duration: 0}).set(0)
		};
	});
